...
$.ajax({
	...
	success :function(res){
		...
		$('.items>div').each(function(){
			...
			$(this).append(`<dl><dt><a href="http://localhost/170901/66/html/productInfo.html?g=${index}"><img src="${arr[index].url}" alt=""></a><a href="#">${arr[index].name}</a></dt><dd><p>市场价：￥<span>${arr[index].mPrice}</span></p><p>商城价：￥<span>${arr[index].sPrice}</span></p></dd></dl>`)
		})
		// 翻页按钮
